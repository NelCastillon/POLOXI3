...
public sealed class IntelligencePlatformContractTests
{
    ...
    public void NotificationConsumers_UseSharedDurableDeliveryWithoutDirectSmtpBypasses()
    {
        ...
        Assert.Contains("UPDLOCK,READPAST,ROWLOCK",delivery,StringComparison.Ordinal);Assert.Contains("env://",delivery,StringComparison.Ordinal);Assert.Contains("ExternalCorrelationId",delivery,StringComparison.Ordinal);Assert.Contains(": BackgroundService",worker,StringComparison.Ordinal);
    }
