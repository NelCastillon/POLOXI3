...
public static class DecisionResearchNeedFactory
{
        ...
        string statusCode = "OPEN") => frontierNeed with
    {
        ...
        ResearchQuestion = leaf.ResearchQuestion.Trim(),
        SearchQuery = leaf.SearchQuery?.Trim(),
        SearchConceptsJson = System.Text.Json.JsonSerializer.Serialize(leaf.SearchConcepts),
        AuthorityKindsJson = System.Text.Json.JsonSerializer.Serialize(leaf.AuthorityKinds),
        ApplicationDeferred = leaf.ApplicationDeferred,
