...
-- ── POLOXI.Legal_WideBranch: explicit semantic role ──
IF OBJECT_ID(N'POLOXI.Legal_WideBranch',N'U') IS NOT NULL
BEGIN
	IF COL_LENGTH(N'POLOXI.Legal_WideBranch',N'BranchRoleCode') IS NULL
		ALTER TABLE POLOXI.Legal_WideBranch ADD BranchRoleCode NVARCHAR(20) NOT NULL CONSTRAINT DF_Legal_PoloxiWideBranch_BranchRole DEFAULT N'PREFERENCE';
END;
