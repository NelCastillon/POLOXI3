...
BEGIN
	IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'IntentEntropy') IS NULL
		ALTER TABLE POLOXI.Legal_WideExecution ADD IntentEntropy DECIMAL(9,4) NULL;
	IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'PriorIntentEntropy') IS NULL
		ALTER TABLE POLOXI.Legal_WideExecution ADD PriorIntentEntropy DECIMAL(9,4) NULL;
	IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'ClarificationGain') IS NULL
		ALTER TABLE POLOXI.Legal_WideExecution ADD ClarificationGain DECIMAL(9,4) NULL;
	IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'ClarificationRound') IS NULL
		ALTER TABLE POLOXI.Legal_WideExecution ADD ClarificationRound INT NOT NULL CONSTRAINT DF_Legal_WideExecution_ClarificationRound DEFAULT(0);
END;
