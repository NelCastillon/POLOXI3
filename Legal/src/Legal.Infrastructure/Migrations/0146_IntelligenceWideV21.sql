...
IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'QueryContractJson') IS NULL
	ALTER TABLE POLOXI.Legal_WideExecution ADD QueryContractJson NVARCHAR(MAX) NULL;
IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'EvidenceCoverage') IS NULL
	ALTER TABLE POLOXI.Legal_WideExecution ADD EvidenceCoverage DECIMAL(5,4) NULL;
IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'ExternalEvidenceCount') IS NULL
	ALTER TABLE POLOXI.Legal_WideExecution ADD ExternalEvidenceCount INT NOT NULL CONSTRAINT DF_Legal_PoloxiWideExecution_ExternalEvidence DEFAULT 0;
IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'EnterpriseEvidenceCount') IS NULL
	ALTER TABLE POLOXI.Legal_WideExecution ADD EnterpriseEvidenceCount INT NOT NULL CONSTRAINT DF_Legal_PoloxiWideExecution_EnterpriseEvidence DEFAULT 0;
IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'CandidateCount') IS NULL
	ALTER TABLE POLOXI.Legal_WideExecution ADD CandidateCount INT NOT NULL CONSTRAINT DF_Legal_PoloxiWideExecution_Candidates DEFAULT 0;

-- Branch: three-score model + branch lifecycle state.
IF COL_LENGTH(N'POLOXI.Legal_WideBranch',N'BranchStateCode') IS NULL
	ALTER TABLE POLOXI.Legal_WideBranch ADD BranchStateCode NVARCHAR(20) NOT NULL CONSTRAINT DF_Legal_PoloxiWideBranch_State DEFAULT N'ACTIVE';
IF COL_LENGTH(N'POLOXI.Legal_WideBranch',N'InterpretationPrior') IS NULL
	ALTER TABLE POLOXI.Legal_WideBranch ADD InterpretationPrior DECIMAL(5,4) NULL;
IF COL_LENGTH(N'POLOXI.Legal_WideBranch',N'EvidenceSupport') IS NULL
	ALTER TABLE POLOXI.Legal_WideBranch ADD EvidenceSupport DECIMAL(5,4) NULL;
IF COL_LENGTH(N'POLOXI.Legal_WideBranch',N'PoloxiConfidence') IS NULL
	ALTER TABLE POLOXI.Legal_WideBranch ADD PoloxiConfidence DECIMAL(5,4) NULL;

-- Candidate universe surviving the hard-constraint filter (never deleted).
IF OBJECT_ID(N'POLOXI.Legal_WideCandidate',N'U') IS NULL
BEGIN
	CREATE TABLE POLOXI.Legal_WideCandidate
	(
		WideCandidateId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_Legal_PoloxiWideCandidate PRIMARY KEY,
		WideExecutionId UNIQUEIDENTIFIER NOT NULL CONSTRAINT FK_Legal_PoloxiWideCandidate_Execution REFERENCES POLOXI.Legal_WideExecution(WideExecutionId),
		TenantId UNIQUEIDENTIFIER NOT NULL,
		DisplayName NVARCHAR(300) NOT NULL,
		Detail NVARCHAR(1000) NULL,
		CompositeScore DECIMAL(5,4) NOT NULL CONSTRAINT DF_Legal_PoloxiWideCandidate_Composite DEFAULT 0,
		RankNumber INT NOT NULL,
		IsConstraintViolation BIT NOT NULL CONSTRAINT DF_Legal_PoloxiWideCandidate_Violation DEFAULT 0,
		ConstraintViolationReason NVARCHAR(400) NULL,
		CreatedDateUtc DATETIME2(3) NOT NULL CONSTRAINT DF_Legal_PoloxiWideCandidate_Created DEFAULT SYSUTCDATETIME(),
		CreatedByUserId UNIQUEIDENTIFIER NULL,
		ModifiedDateUtc DATETIME2(3) NULL,
		ModifiedByUserId UNIQUEIDENTIFIER NULL,
		IsDeleted BIT NOT NULL CONSTRAINT DF_Legal_PoloxiWideCandidate_Deleted DEFAULT 0
	);
	CREATE INDEX IX_Legal_PoloxiWideCandidate_Execution ON POLOXI.Legal_WideCandidate(WideExecutionId,RankNumber) WHERE IsDeleted=0;
END;

-- Candidate x Branch evidence score matrix.
IF OBJECT_ID(N'POLOXI.Legal_WideCandidateBranchScore',N'U') IS NULL
BEGIN
	CREATE TABLE POLOXI.Legal_WideCandidateBranchScore
	(
		WideCandidateBranchScoreId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_Legal_PoloxiWideCandidateBranchScore PRIMARY KEY,
		WideCandidateId UNIQUEIDENTIFIER NOT NULL CONSTRAINT FK_Legal_PoloxiWideCandidateBranchScore_Candidate REFERENCES POLOXI.Legal_WideCandidate(WideCandidateId),
		WideBranchId UNIQUEIDENTIFIER NOT NULL CONSTRAINT FK_Legal_PoloxiWideCandidateBranchScore_Branch REFERENCES POLOXI.Legal_WideBranch(WideBranchId),
		TenantId UNIQUEIDENTIFIER NOT NULL,
		BranchDisplayName NVARCHAR(300) NOT NULL,
		EvidenceScore DECIMAL(5,4) NOT NULL CONSTRAINT DF_Legal_PoloxiWideCandidateBranchScore_Score DEFAULT 0,
		CreatedDateUtc DATETIME2(3) NOT NULL CONSTRAINT DF_Legal_PoloxiWideCandidateBranchScore_Created DEFAULT SYSUTCDATETIME(),
		CreatedByUserId UNIQUEIDENTIFIER NULL,
		ModifiedDateUtc DATETIME2(3) NULL,
		ModifiedByUserId UNIQUEIDENTIFIER NULL,
		IsDeleted BIT NOT NULL CONSTRAINT DF_Legal_PoloxiWideCandidateBranchScore_Deleted DEFAULT 0
	);
	CREATE INDEX IX_Legal_PoloxiWideCandidateBranchScore_Candidate ON POLOXI.Legal_WideCandidateBranchScore(WideCandidateId) WHERE IsDeleted=0;
END;
