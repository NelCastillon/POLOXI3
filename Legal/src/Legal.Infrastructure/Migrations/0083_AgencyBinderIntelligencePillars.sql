...
IF OBJECT_ID(N'AI.Legal_IntelligencePillar', N'U') IS NULL
BEGIN
	CREATE TABLE AI.Legal_IntelligencePillar
	(
		IntelligencePillarId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_Legal_AI_IntelligencePillar PRIMARY KEY,
		...
		CreatedDateUtc DATETIME2 NOT NULL CONSTRAINT DF_Legal_AI_IntelligencePillar_Created DEFAULT SYSUTCDATETIME(),
		CreatedByUserId UNIQUEIDENTIFIER NULL,
		ModifiedDateUtc DATETIME2 NULL,
		ModifiedByUserId UNIQUEIDENTIFIER NULL,
		IsDeleted BIT NOT NULL CONSTRAINT DF_Legal_AI_IntelligencePillar_Deleted DEFAULT 0,
		RowVersion ROWVERSION NOT NULL
	);
	CREATE UNIQUE INDEX UX_AI_IntelligencePillar_Code ON AI.Legal_IntelligencePillar(PillarCode) WHERE TenantId IS NULL AND IsDeleted = 0;
END;

IF OBJECT_ID(N'AI.Legal_IntelligenceCapability', N'U') IS NULL
BEGIN
	CREATE TABLE AI.Legal_IntelligenceCapability
	(
		IntelligenceCapabilityId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_Legal_AI_IntelligenceCapability PRIMARY KEY,
		TenantId UNIQUEIDENTIFIER NULL,
		...
		SortOrder INT NOT NULL,
		IsActive BIT NOT NULL,
		CreatedDateUtc DATETIME2 NOT NULL CONSTRAINT DF_Legal_AI_IntelligenceCapability_Created DEFAULT SYSUTCDATETIME(),
		CreatedByUserId UNIQUEIDENTIFIER NULL,
		ModifiedDateUtc DATETIME2 NULL,
		ModifiedByUserId UNIQUEIDENTIFIER NULL,
		IsDeleted BIT NOT NULL CONSTRAINT DF_Legal_AI_IntelligenceCapability_Deleted DEFAULT 0,
		RowVersion ROWVERSION NOT NULL,
		CONSTRAINT FK_Legal_AI_IntelligenceCapability_Pillar FOREIGN KEY(IntelligencePillarId) REFERENCES AI.Legal_IntelligencePillar(IntelligencePillarId)
	);
	CREATE UNIQUE INDEX UX_AI_IntelligenceCapability_Code ON AI.Legal_IntelligenceCapability(CapabilityCode) WHERE TenantId IS NULL AND IsDeleted = 0;
	CREATE INDEX IX_Legal_AI_IntelligenceCapability_Pillar ON AI.Legal_IntelligenceCapability(IntelligencePillarId, SortOrder) INCLUDE(CapabilityCode, DisplayName, IsActive);
END;

IF OBJECT_ID(N'AI.Legal_EnginePolicy', N'U') IS NULL
BEGIN
	CREATE TABLE AI.Legal_EnginePolicy
	(
		EnginePolicyId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_Legal_AI_EnginePolicy PRIMARY KEY DEFAULT NEWID(),
		TenantId UNIQUEIDENTIFIER NULL,
		...
		IsActive BIT NOT NULL,
		CreatedDateUtc DATETIME2 NOT NULL CONSTRAINT DF_Legal_AI_EnginePolicy_Created DEFAULT SYSUTCDATETIME(),
		CreatedByUserId UNIQUEIDENTIFIER NULL,
		ModifiedDateUtc DATETIME2 NULL,
		ModifiedByUserId UNIQUEIDENTIFIER NULL,
		IsDeleted BIT NOT NULL CONSTRAINT DF_Legal_AI_EnginePolicy_Deleted DEFAULT 0,
		RowVersion ROWVERSION NOT NULL,
		CONSTRAINT FK_Legal_AI_EnginePolicy_Capability FOREIGN KEY(IntelligenceCapabilityId) REFERENCES AI.Legal_IntelligenceCapability(IntelligenceCapabilityId),
		CONSTRAINT CK_Legal_AI_EnginePolicy_Confidence CHECK(MinimumConfidence BETWEEN 0 AND 1),
		CONSTRAINT CK_Legal_AI_EnginePolicy_Version CHECK(VersionNumber > 0),
		CONSTRAINT CK_Legal_AI_EnginePolicy_Dates CHECK(EffectiveToUtc IS NULL OR EffectiveToUtc > EffectiveFromUtc),
		CONSTRAINT CK_Legal_AI_EnginePolicy_Json CHECK(ISJSON(ConfigurationJson) = 1)
	);
	CREATE UNIQUE INDEX UX_AI_EnginePolicy_CodeVersion ON AI.Legal_EnginePolicy(PolicyCode, VersionNumber) WHERE TenantId IS NULL AND IsDeleted = 0;
	CREATE INDEX IX_Legal_AI_EnginePolicy_Active ON AI.Legal_EnginePolicy(TenantId, IntelligenceCapabilityId, IsActive, EffectiveFromUtc DESC) INCLUDE(PolicyCode, ExecutionModeCode, MinimumConfidence, RequiresHumanReview);
END;

IF OBJECT_ID(N'AI.Legal_PromptDefinition', N'U') IS NULL
BEGIN
	CREATE TABLE AI.Legal_PromptDefinition
	(
		PromptDefinitionId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_Legal_AI_PromptDefinition PRIMARY KEY DEFAULT NEWID(),
		TenantId UNIQUEIDENTIFIER NULL,
		IntelligenceCapabilityId UNIQUEIDENTIFIER NOT NULL,
		...
		EffectiveToUtc DATETIME2 NULL,
		CreatedDateUtc DATETIME2 NOT NULL CONSTRAINT DF_Legal_AI_PromptDefinition_Created DEFAULT SYSUTCDATETIME(),
		CreatedByUserId UNIQUEIDENTIFIER NULL,
		ModifiedDateUtc DATETIME2 NULL,
		ModifiedByUserId UNIQUEIDENTIFIER NULL,
		IsDeleted BIT NOT NULL CONSTRAINT DF_Legal_AI_PromptDefinition_Deleted DEFAULT 0,
		RowVersion ROWVERSION NOT NULL,
		CONSTRAINT FK_Legal_AI_PromptDefinition_Capability FOREIGN KEY(IntelligenceCapabilityId) REFERENCES AI.Legal_IntelligenceCapability(IntelligenceCapabilityId),
		CONSTRAINT CK_Legal_AI_PromptDefinition_Status CHECK(StatusCode IN(N'DRAFT', N'APPROVED', N'RETIRED')),
		CONSTRAINT CK_Legal_AI_PromptDefinition_InputJson CHECK(ISJSON(InputSchemaJson) = 1),
		CONSTRAINT CK_Legal_AI_PromptDefinition_OutputJson CHECK(ISJSON(OutputSchemaJson) = 1),
		CONSTRAINT CK_Legal_AI_PromptDefinition_Approval CHECK(StatusCode <> N'APPROVED' OR (ApprovedByUserId IS NOT NULL AND ApprovedDateUtc IS NOT NULL))
	);
	CREATE UNIQUE INDEX UX_AI_PromptDefinition_Version ON AI.Legal_PromptDefinition(PromptCode, VersionLabel) WHERE TenantId IS NULL AND IsDeleted = 0;
END;

IF OBJECT_ID(N'AI.Legal_SafetyControl', N'U') IS NULL
BEGIN
	CREATE TABLE AI.Legal_SafetyControl
	(
		SafetyControlId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_Legal_AI_SafetyControl PRIMARY KEY DEFAULT NEWID(),
		TenantId UNIQUEIDENTIFIER NULL,
		...
		SortOrder INT NOT NULL,
		IsActive BIT NOT NULL,
		CreatedDateUtc DATETIME2 NOT NULL CONSTRAINT DF_Legal_AI_SafetyControl_Created DEFAULT SYSUTCDATETIME(),
		CreatedByUserId UNIQUEIDENTIFIER NULL,
		ModifiedDateUtc DATETIME2 NULL,
		ModifiedByUserId UNIQUEIDENTIFIER NULL,
		IsDeleted BIT NOT NULL CONSTRAINT DF_Legal_AI_SafetyControl_Deleted DEFAULT 0,
		RowVersion ROWVERSION NOT NULL,
		CONSTRAINT CK_Legal_AI_SafetyControl_Json CHECK(ISJSON(ConfigurationJson) = 1)
	);
	CREATE UNIQUE INDEX UX_AI_SafetyControl_Code ON AI.Legal_SafetyControl(ControlCode) WHERE TenantId IS NULL AND IsDeleted = 0;
END;

IF OBJECT_ID(N'AI.Legal_IntelligenceFinding', N'U') IS NULL
BEGIN
	CREATE TABLE AI.Legal_IntelligenceFinding
	(
		IntelligenceFindingId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_Legal_AI_IntelligenceFinding PRIMARY KEY DEFAULT NEWID(),
		...
		CreatedDateUtc DATETIME2 NOT NULL CONSTRAINT DF_Legal_AI_IntelligenceFinding_Created DEFAULT SYSUTCDATETIME(),
		CreatedByUserId UNIQUEIDENTIFIER NULL,
		ModifiedDateUtc DATETIME2 NULL,
		ModifiedByUserId UNIQUEIDENTIFIER NULL,
		IsDeleted BIT NOT NULL CONSTRAINT DF_Legal_AI_IntelligenceFinding_Deleted DEFAULT 0,
		RowVersion ROWVERSION NOT NULL,
		CONSTRAINT FK_Legal_AI_IntelligenceFinding_Capability FOREIGN KEY(IntelligenceCapabilityId) REFERENCES AI.Legal_IntelligenceCapability(IntelligenceCapabilityId),
		CONSTRAINT FK_Legal_AI_IntelligenceFinding_Policy FOREIGN KEY(EnginePolicyId) REFERENCES AI.Legal_EnginePolicy(EnginePolicyId),
		CONSTRAINT FK_Legal_AI_IntelligenceFinding_Execution FOREIGN KEY(ExecutionId) REFERENCES AI.Legal_Execution(ExecutionId),
		CONSTRAINT CK_Legal_AI_IntelligenceFinding_Confidence CHECK(Confidence IS NULL OR Confidence BETWEEN 0 AND 1)
	);
	CREATE UNIQUE INDEX UX_AI_IntelligenceFinding_Idempotency ON AI.Legal_IntelligenceFinding(TenantId, IdempotencyKey) WHERE IsDeleted = 0;
	CREATE INDEX IX_Legal_AI_IntelligenceFinding_Entity ON AI.Legal_IntelligenceFinding(TenantId, EntityTypeCode, EntityId, StatusCode, DetectedDateUtc DESC) INCLUDE(IntelligenceCapabilityId, SeverityCode, Title, Score, Confidence);
END;

IF OBJECT_ID(N'AI.Legal_FindingEvidence', N'U') IS NULL
BEGIN
	CREATE TABLE AI.Legal_FindingEvidence
	(
		FindingEvidenceId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_Legal_AI_FindingEvidence PRIMARY KEY DEFAULT NEWID(),
		TenantId UNIQUEIDENTIFIER NOT NULL,
		...
		CreatedDateUtc DATETIME2 NOT NULL CONSTRAINT DF_Legal_AI_FindingEvidence_Created DEFAULT SYSUTCDATETIME(),
		CreatedByUserId UNIQUEIDENTIFIER NULL,
		ModifiedDateUtc DATETIME2 NULL,
		ModifiedByUserId UNIQUEIDENTIFIER NULL,
		IsDeleted BIT NOT NULL CONSTRAINT DF_Legal_AI_FindingEvidence_Deleted DEFAULT 0,
		RowVersion ROWVERSION NOT NULL,
		CONSTRAINT FK_Legal_AI_FindingEvidence_Finding FOREIGN KEY(IntelligenceFindingId) REFERENCES AI.Legal_IntelligenceFinding(IntelligenceFindingId),
		CONSTRAINT CK_Legal_AI_FindingEvidence_Json CHECK(EvidenceValueJson IS NULL OR ISJSON(EvidenceValueJson) = 1),
		CONSTRAINT CK_Legal_AI_FindingEvidence_Relevance CHECK(RelevanceScore IS NULL OR RelevanceScore BETWEEN 0 AND 1)
	);
	CREATE INDEX IX_Legal_AI_FindingEvidence_Finding ON AI.Legal_FindingEvidence(TenantId, IntelligenceFindingId, CreatedDateUtc) INCLUDE(EvidenceTypeCode, SourceModuleCode, SourceEntityTypeCode, SourceEntityId);
END;

IF OBJECT_ID(N'AI.Legal_EntityRelationship', N'U') IS NULL
BEGIN
	CREATE TABLE AI.Legal_EntityRelationship
	(
		EntityRelationshipId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_Legal_AI_EntityRelationship PRIMARY KEY DEFAULT NEWID(),
		TenantId UNIQUEIDENTIFIER NOT NULL,
		...
		CreatedDateUtc DATETIME2 NOT NULL CONSTRAINT DF_Legal_AI_EntityRelationship_Created DEFAULT SYSUTCDATETIME(),
		CreatedByUserId UNIQUEIDENTIFIER NULL,
		ModifiedDateUtc DATETIME2 NULL,
		ModifiedByUserId UNIQUEIDENTIFIER NULL,
		IsDeleted BIT NOT NULL CONSTRAINT DF_Legal_AI_EntityRelationship_Deleted DEFAULT 0,
		RowVersion ROWVERSION NOT NULL,
		CONSTRAINT CK_Legal_AI_EntityRelationship_Strength CHECK(Strength BETWEEN 0 AND 1),
		CONSTRAINT CK_Legal_AI_EntityRelationship_Dates CHECK(EffectiveToUtc IS NULL OR EffectiveFromUtc IS NULL OR EffectiveToUtc > EffectiveFromUtc)
	);
	CREATE UNIQUE INDEX UX_AI_EntityRelationship_Edge ON AI.Legal_EntityRelationship(TenantId, SourceEntityTypeCode, SourceEntityId, RelationshipTypeCode, TargetEntityTypeCode, TargetEntityId) WHERE IsDeleted = 0;
	CREATE INDEX IX_Legal_AI_EntityRelationship_Target ON AI.Legal_EntityRelationship(TenantId, TargetEntityTypeCode, TargetEntityId, RelationshipTypeCode) INCLUDE(SourceEntityTypeCode, SourceEntityId, Strength);
END;

IF OBJECT_ID(N'AI.Legal_EntitySimilarity', N'U') IS NULL
BEGIN
	CREATE TABLE AI.Legal_EntitySimilarity
	(
		EntitySimilarityId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_Legal_AI_EntitySimilarity PRIMARY KEY DEFAULT NEWID(),
		TenantId UNIQUEIDENTIFIER NOT NULL,
		EntityTypeCode NVARCHAR(100) NOT NULL,
		SourceEntityId UNIQUEIDENTIFIER NOT NULL,
		...
		CreatedDateUtc DATETIME2 NOT NULL CONSTRAINT DF_Legal_AI_EntitySimilarity_Created DEFAULT SYSUTCDATETIME(),
		CreatedByUserId UNIQUEIDENTIFIER NULL,
		ModifiedDateUtc DATETIME2 NULL,
		ModifiedByUserId UNIQUEIDENTIFIER NULL,
		IsDeleted BIT NOT NULL CONSTRAINT DF_Legal_AI_EntitySimilarity_Deleted DEFAULT 0,
		RowVersion ROWVERSION NOT NULL,
		CONSTRAINT CK_Legal_AI_EntitySimilarity_Score CHECK(SimilarityScore BETWEEN 0 AND 1),
		CONSTRAINT CK_Legal_AI_EntitySimilarity_Json CHECK(ISJSON(FeatureEvidenceJson) = 1),
		CONSTRAINT CK_Legal_AI_EntitySimilarity_Different CHECK(SourceEntityId <> SimilarEntityId)
	);
	CREATE UNIQUE INDEX UX_AI_EntitySimilarity_Pair ON AI.Legal_EntitySimilarity(TenantId, EntityTypeCode, SourceEntityId, SimilarEntityId, SimilarityModelCode, SimilarityModelVersion) WHERE IsDeleted = 0;
	CREATE INDEX IX_Legal_AI_EntitySimilarity_Rank ON AI.Legal_EntitySimilarity(TenantId, EntityTypeCode, SourceEntityId, SimilarityScore DESC) INCLUDE(SimilarEntityId, SimilarityModelCode, CalculatedDateUtc);
END;

IF OBJECT_ID(N'AI.Legal_BusinessSignal', N'U') IS NULL
BEGIN
	CREATE TABLE AI.Legal_BusinessSignal
	(
		BusinessSignalId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_Legal_AI_BusinessSignal PRIMARY KEY DEFAULT NEWID(),
		TenantId UNIQUEIDENTIFIER NOT NULL,
		IntelligenceCapabilityId UNIQUEIDENTIFIER NOT NULL,
		EntityTypeCode NVARCHAR(100) NOT NULL,
		EntityId UNIQUEIDENTIFIER NOT NULL,
		...
		DueDateUtc DATETIME2 NULL,
		IdempotencyKey NVARCHAR(240) NOT NULL,
		CreatedDateUtc DATETIME2 NOT NULL CONSTRAINT DF_Legal_AI_BusinessSignal_Created DEFAULT SYSUTCDATETIME(),
		CreatedByUserId UNIQUEIDENTIFIER NULL,
		ModifiedDateUtc DATETIME2 NULL,
		ModifiedByUserId UNIQUEIDENTIFIER NULL,
		IsDeleted BIT NOT NULL CONSTRAINT DF_Legal_AI_BusinessSignal_Deleted DEFAULT 0,
		RowVersion ROWVERSION NOT NULL,
		CONSTRAINT FK_Legal_AI_BusinessSignal_Capability FOREIGN KEY(IntelligenceCapabilityId) REFERENCES AI.Legal_IntelligenceCapability(IntelligenceCapabilityId),
		CONSTRAINT CK_Legal_AI_BusinessSignal_Confidence CHECK(Confidence IS NULL OR Confidence BETWEEN 0 AND 1),
		CONSTRAINT CK_Legal_AI_BusinessSignal_Json CHECK(ISJSON(EvidenceJson) = 1)
	);
	CREATE UNIQUE INDEX UX_AI_BusinessSignal_Idempotency ON AI.Legal_BusinessSignal(TenantId, IdempotencyKey) WHERE IsDeleted = 0;
	CREATE INDEX IX_Legal_AI_BusinessSignal_Queue ON AI.Legal_BusinessSignal(TenantId, StatusCode, SeverityCode, SignalDateUtc DESC) INCLUDE(IntelligenceCapabilityId, EntityTypeCode, EntityId, Title, Score, AssignedToUserId);
END;

IF OBJECT_ID(N'AI.Legal_ReasoningSession', N'U') IS NULL
BEGIN
	CREATE TABLE AI.Legal_ReasoningSession
	(
		ReasoningSessionId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_Legal_AI_ReasoningSession PRIMARY KEY DEFAULT NEWID(),
		TenantId UNIQUEIDENTIFIER NOT NULL,
		...
		CreatedDateUtc DATETIME2 NOT NULL CONSTRAINT DF_Legal_AI_ReasoningSession_Created DEFAULT SYSUTCDATETIME(),
		CreatedByUserId UNIQUEIDENTIFIER NULL,
		ModifiedDateUtc DATETIME2 NULL,
		ModifiedByUserId UNIQUEIDENTIFIER NULL,
		IsDeleted BIT NOT NULL CONSTRAINT DF_Legal_AI_ReasoningSession_Deleted DEFAULT 0,
		RowVersion ROWVERSION NOT NULL,
		CONSTRAINT FK_Legal_AI_ReasoningSession_Policy FOREIGN KEY(EnginePolicyId) REFERENCES AI.Legal_EnginePolicy(EnginePolicyId),
		CONSTRAINT FK_Legal_AI_ReasoningSession_Execution FOREIGN KEY(ExecutionId) REFERENCES AI.Legal_Execution(ExecutionId),
		CONSTRAINT CK_Legal_AI_ReasoningSession_Confidence CHECK(Confidence IS NULL OR Confidence BETWEEN 0 AND 1)
	);
	CREATE UNIQUE INDEX UX_AI_ReasoningSession_Correlation ON AI.Legal_ReasoningSession(TenantId, CorrelationId) WHERE IsDeleted = 0;
	CREATE INDEX IX_Legal_AI_ReasoningSession_Entity ON AI.Legal_ReasoningSession(TenantId, EntityTypeCode, EntityId, CreatedDateUtc DESC) INCLUDE(StatusCode, IntentCode, RequestedByUserId, Confidence, RequiresHumanReview);
END;

IF OBJECT_ID(N'AI.Legal_ReasoningEvidence', N'U') IS NULL
BEGIN
	CREATE TABLE AI.Legal_ReasoningEvidence
	(
		ReasoningEvidenceId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_Legal_AI_ReasoningEvidence PRIMARY KEY DEFAULT NEWID(),
		TenantId UNIQUEIDENTIFIER NOT NULL,
		...
		CreatedDateUtc DATETIME2 NOT NULL CONSTRAINT DF_Legal_AI_ReasoningEvidence_Created DEFAULT SYSUTCDATETIME(),
		CreatedByUserId UNIQUEIDENTIFIER NULL,
		ModifiedDateUtc DATETIME2 NULL,
		ModifiedByUserId UNIQUEIDENTIFIER NULL,
		IsDeleted BIT NOT NULL CONSTRAINT DF_Legal_AI_ReasoningEvidence_Deleted DEFAULT 0,
		RowVersion ROWVERSION NOT NULL,
		CONSTRAINT FK_Legal_AI_ReasoningEvidence_Session FOREIGN KEY(ReasoningSessionId) REFERENCES AI.Legal_ReasoningSession(ReasoningSessionId),
		CONSTRAINT CK_Legal_AI_ReasoningEvidence_Relevance CHECK(RelevanceScore BETWEEN 0 AND 1),
		CONSTRAINT CK_Legal_AI_ReasoningEvidence_Json CHECK(EvidenceValueJson IS NULL OR ISJSON(EvidenceValueJson) = 1)
	);
	CREATE INDEX IX_Legal_AI_ReasoningEvidence_Session ON AI.Legal_ReasoningEvidence(TenantId, ReasoningSessionId, RelevanceScore DESC) INCLUDE(EvidenceTypeCode, SourceModuleCode, IsAuthoritative);
END;

IF OBJECT_ID(N'AI.Legal_ReasoningConclusion', N'U') IS NULL
BEGIN
	CREATE TABLE AI.Legal_ReasoningConclusion
	(
		ReasoningConclusionId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_Legal_AI_ReasoningConclusion PRIMARY KEY DEFAULT NEWID(),
		TenantId UNIQUEIDENTIFIER NOT NULL,
		ReasoningSessionId UNIQUEIDENTIFIER NOT NULL,
		...
		CreatedDateUtc DATETIME2 NOT NULL CONSTRAINT DF_Legal_AI_ReasoningConclusion_Created DEFAULT SYSUTCDATETIME(),
		CreatedByUserId UNIQUEIDENTIFIER NULL,
		ModifiedDateUtc DATETIME2 NULL,
		ModifiedByUserId UNIQUEIDENTIFIER NULL,
		IsDeleted BIT NOT NULL CONSTRAINT DF_Legal_AI_ReasoningConclusion_Deleted DEFAULT 0,
		RowVersion ROWVERSION NOT NULL,
		CONSTRAINT FK_Legal_AI_ReasoningConclusion_Session FOREIGN KEY(ReasoningSessionId) REFERENCES AI.Legal_ReasoningSession(ReasoningSessionId),
		CONSTRAINT CK_Legal_AI_ReasoningConclusion_Sequence CHECK(SequenceNumber > 0),
		CONSTRAINT CK_Legal_AI_ReasoningConclusion_Confidence CHECK(Confidence BETWEEN 0 AND 1)
	);
	CREATE UNIQUE INDEX UX_AI_ReasoningConclusion_Sequence ON AI.Legal_ReasoningConclusion(TenantId, ReasoningSessionId, SequenceNumber) WHERE IsDeleted = 0;
END;

IF OBJECT_ID(N'AI.Legal_ReasoningAction', N'U') IS NULL
BEGIN
	CREATE TABLE AI.Legal_ReasoningAction
	(
		ReasoningActionId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_Legal_AI_ReasoningAction PRIMARY KEY DEFAULT NEWID(),
		TenantId UNIQUEIDENTIFIER NOT NULL,
		ReasoningSessionId UNIQUEIDENTIFIER NOT NULL,
		SequenceNumber INT NOT NULL,
		...
		CreatedDateUtc DATETIME2 NOT NULL CONSTRAINT DF_Legal_AI_ReasoningAction_Created DEFAULT SYSUTCDATETIME(),
		CreatedByUserId UNIQUEIDENTIFIER NULL,
		ModifiedDateUtc DATETIME2 NULL,
		ModifiedByUserId UNIQUEIDENTIFIER NULL,
		IsDeleted BIT NOT NULL CONSTRAINT DF_Legal_AI_ReasoningAction_Deleted DEFAULT 0,
		RowVersion ROWVERSION NOT NULL,
		CONSTRAINT FK_Legal_AI_ReasoningAction_Session FOREIGN KEY(ReasoningSessionId) REFERENCES AI.Legal_ReasoningSession(ReasoningSessionId),
		CONSTRAINT CK_Legal_AI_ReasoningAction_Sequence CHECK(SequenceNumber > 0)
	);
	CREATE UNIQUE INDEX UX_AI_ReasoningAction_Sequence ON AI.Legal_ReasoningAction(TenantId, ReasoningSessionId, SequenceNumber) WHERE IsDeleted = 0;
END;

IF OBJECT_ID(N'AI.Legal_IntelligenceWorkItem', N'U') IS NULL
BEGIN
	CREATE TABLE AI.Legal_IntelligenceWorkItem
	(
		IntelligenceWorkItemId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_Legal_AI_IntelligenceWorkItem PRIMARY KEY DEFAULT NEWID(),
		TenantId UNIQUEIDENTIFIER NOT NULL,
		IntelligenceCapabilityId UNIQUEIDENTIFIER NOT NULL,
		...
		CreatedDateUtc DATETIME2 NOT NULL CONSTRAINT DF_Legal_AI_IntelligenceWorkItem_Created DEFAULT SYSUTCDATETIME(),
		CreatedByUserId UNIQUEIDENTIFIER NULL,
		ModifiedDateUtc DATETIME2 NULL,
		ModifiedByUserId UNIQUEIDENTIFIER NULL,
		IsDeleted BIT NOT NULL CONSTRAINT DF_Legal_AI_IntelligenceWorkItem_Deleted DEFAULT 0,
		RowVersion ROWVERSION NOT NULL,
		CONSTRAINT FK_Legal_AI_IntelligenceWorkItem_Capability FOREIGN KEY(IntelligenceCapabilityId) REFERENCES AI.Legal_IntelligenceCapability(IntelligenceCapabilityId),
		CONSTRAINT CK_Legal_AI_IntelligenceWorkItem_Payload CHECK(ISJSON(PayloadJson) = 1),
		CONSTRAINT CK_Legal_AI_IntelligenceWorkItem_Attempts CHECK(AttemptCount >= 0 AND MaximumAttempts > 0),
		CONSTRAINT CK_Legal_AI_IntelligenceWorkItem_Priority CHECK(Priority BETWEEN 1 AND 100)
	);
	CREATE UNIQUE INDEX UX_AI_IntelligenceWorkItem_Idempotency ON AI.Legal_IntelligenceWorkItem(TenantId, IdempotencyKey) WHERE IsDeleted = 0;
	CREATE INDEX IX_Legal_AI_IntelligenceWorkItem_Queue ON AI.Legal_IntelligenceWorkItem(StatusCode, AvailableDateUtc, Priority DESC) INCLUDE(TenantId, IntelligenceCapabilityId, WorkTypeCode, AttemptCount, MaximumAttempts, LeaseExpiresDateUtc);
END;
...
MERGE AI.Legal_IntelligencePillar AS target USING @Pillars AS source ON target.IntelligencePillarId = source.PillarId
...
MERGE AI.Legal_IntelligenceCapability AS target USING @Capabilities AS source ON target.IntelligenceCapabilityId = source.CapabilityId
...
MERGE AI.Legal_SafetyControl AS target USING @Safety AS source ON target.TenantId IS NULL AND target.ControlCode=source.ControlCode
