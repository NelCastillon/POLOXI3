...
--   1. POLOXI.Legal_WideExecution.AnswerKindCode persists the governing classification for audit
...
BEGIN
	IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'AnswerKindCode') IS NULL
		ALTER TABLE POLOXI.Legal_WideExecution ADD AnswerKindCode NVARCHAR(30) NULL;
END;
