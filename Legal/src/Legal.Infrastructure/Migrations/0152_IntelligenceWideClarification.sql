...
BEGIN
	IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'DecisionConfidence') IS NULL
		ALTER TABLE POLOXI.Legal_WideExecution ADD DecisionConfidence DECIMAL(9,4) NULL;
	IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'ClarificationTarget') IS NULL
		ALTER TABLE POLOXI.Legal_WideExecution ADD ClarificationTarget NVARCHAR(300) NULL;
	IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'ClarificationQuestion') IS NULL
		ALTER TABLE POLOXI.Legal_WideExecution ADD ClarificationQuestion NVARCHAR(1000) NULL;
END;
