...
IF OBJECT_ID(N'AI.Legal_SearchDocument',N'U') IS NOT NULL AND OBJECT_ID(N'Search.EntityProjection',N'U') IS NOT NULL
BEGIN
	...
	MERGE AI.Legal_SearchDocument target USING SearchSource source
	...
	IF OBJECT_ID(N'IAM.RolePermission',N'U') IS NOT NULL AND OBJECT_ID(N'IAM.Role',N'U') IS NOT NULL AND OBJECT_ID(N'AI.Legal_SearchPermission',N'U') IS NOT NULL
	BEGIN
		MERGE AI.Legal_SearchPermission target USING
		(
