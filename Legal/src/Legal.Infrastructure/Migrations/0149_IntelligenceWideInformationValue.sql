...
-- ── POLOXI.Legal_WideInformationRound: one row per information-directed exploration round ──
IF OBJECT_ID(N'POLOXI.Legal_WideInformationRound',N'U') IS NULL
BEGIN
	CREATE TABLE POLOXI.Legal_WideInformationRound
	(
		WideInformationRoundId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_Legal_PoloxiWideInformationRound PRIMARY KEY,
		WideExecutionId UNIQUEIDENTIFIER NOT NULL CONSTRAINT FK_Legal_PoloxiWideInformationRound_Execution REFERENCES POLOXI.Legal_WideExecution(WideExecutionId),
		...
		SelectedTargetCount INT NOT NULL CONSTRAINT DF_Legal_PoloxiWideInfoRound_Selected DEFAULT 0,
		StartedDateUtc DATETIME2(3) NOT NULL CONSTRAINT DF_Legal_PoloxiWideInfoRound_Started DEFAULT SYSUTCDATETIME(),
		CompletedDateUtc DATETIME2(3) NULL,
		CreatedDateUtc DATETIME2(3) NOT NULL CONSTRAINT DF_Legal_PoloxiWideInfoRound_Created DEFAULT SYSUTCDATETIME(),
		CreatedByUserId UNIQUEIDENTIFIER NULL,
		ModifiedDateUtc DATETIME2(3) NULL,
		ModifiedByUserId UNIQUEIDENTIFIER NULL,
		IsDeleted BIT NOT NULL CONSTRAINT DF_Legal_PoloxiWideInfoRound_Deleted DEFAULT 0
	);
	CREATE INDEX IX_Legal_PoloxiWideInfoRound_Execution ON POLOXI.Legal_WideInformationRound(WideExecutionId,RoundNumber) WHERE IsDeleted=0;
END;

-- ── POLOXI.Legal_WideInformationTarget: one row per evaluated candidate investigation ──
IF OBJECT_ID(N'POLOXI.Legal_WideInformationTarget',N'U') IS NULL
BEGIN
	CREATE TABLE POLOXI.Legal_WideInformationTarget
	(
		WideInformationTargetId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_Legal_PoloxiWideInformationTarget PRIMARY KEY,
		WideInformationRoundId UNIQUEIDENTIFIER NOT NULL CONSTRAINT FK_Legal_PoloxiWideInfoTarget_Round REFERENCES POLOXI.Legal_WideInformationRound(WideInformationRoundId),
		WideBranchId UNIQUEIDENTIFIER NOT NULL CONSTRAINT FK_Legal_PoloxiWideInfoTarget_Branch REFERENCES POLOXI.Legal_WideBranch(WideBranchId),
		TenantId UNIQUEIDENTIFIER NOT NULL,
		...
		WasSelected BIT NOT NULL CONSTRAINT DF_Legal_PoloxiWideInfoTarget_Selected DEFAULT 0,
		SelectionRank INT NULL,
		EvidenceTarget NVARCHAR(1000) NULL,
		Rationale NVARCHAR(1000) NULL,
		PredictedRankingImpactCount INT NOT NULL CONSTRAINT DF_Legal_PoloxiWideInfoTarget_PredCount DEFAULT 0,
		PredictedUpCount INT NOT NULL CONSTRAINT DF_Legal_PoloxiWideInfoTarget_PredUp DEFAULT 0,
		PredictedDownCount INT NOT NULL CONSTRAINT DF_Legal_PoloxiWideInfoTarget_PredDown DEFAULT 0,
		DirectionAccuracy DECIMAL(5,4) NULL,
		MagnitudeAccuracy DECIMAL(5,4) NULL,
		CreatedDateUtc DATETIME2(3) NOT NULL CONSTRAINT DF_Legal_PoloxiWideInfoTarget_Created DEFAULT SYSUTCDATETIME(),
		CreatedByUserId UNIQUEIDENTIFIER NULL,
		ModifiedDateUtc DATETIME2(3) NULL,
		ModifiedByUserId UNIQUEIDENTIFIER NULL,
		IsDeleted BIT NOT NULL CONSTRAINT DF_Legal_PoloxiWideInfoTarget_Deleted DEFAULT 0
	);
	CREATE INDEX IX_Legal_PoloxiWideInfoTarget_Round ON POLOXI.Legal_WideInformationTarget(WideInformationRoundId) WHERE IsDeleted=0;
END;

-- ── POLOXI.Legal_WideInformationPrediction: falsifiable per-candidate ranking predictions ──
IF OBJECT_ID(N'POLOXI.Legal_WideInformationPrediction',N'U') IS NULL
BEGIN
	CREATE TABLE POLOXI.Legal_WideInformationPrediction
	(
		WideInformationPredictionId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_Legal_PoloxiWideInformationPrediction PRIMARY KEY,
		WideInformationTargetId UNIQUEIDENTIFIER NOT NULL CONSTRAINT FK_Legal_PoloxiWideInfoPrediction_Target REFERENCES POLOXI.Legal_WideInformationTarget(WideInformationTargetId),
		TenantId UNIQUEIDENTIFIER NOT NULL,
		...
		CreatedDateUtc DATETIME2(3) NOT NULL CONSTRAINT DF_Legal_PoloxiWideInfoPrediction_Created DEFAULT SYSUTCDATETIME(),
		CreatedByUserId UNIQUEIDENTIFIER NULL,
		ModifiedDateUtc DATETIME2(3) NULL,
		ModifiedByUserId UNIQUEIDENTIFIER NULL,
		IsDeleted BIT NOT NULL CONSTRAINT DF_Legal_PoloxiWideInfoPrediction_Deleted DEFAULT 0
	);
	CREATE INDEX IX_Legal_PoloxiWideInfoPrediction_Target ON POLOXI.Legal_WideInformationPrediction(WideInformationTargetId) WHERE IsDeleted=0;
END;

-- ── Execution-level entropy/IG columns ──
IF OBJECT_ID(N'POLOXI.Legal_WideExecution',N'U') IS NOT NULL
BEGIN
	IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'InitialEntropy') IS NULL
		ALTER TABLE POLOXI.Legal_WideExecution ADD InitialEntropy DECIMAL(9,4) NULL;
	IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'FinalEntropy') IS NULL
		ALTER TABLE POLOXI.Legal_WideExecution ADD FinalEntropy DECIMAL(9,4) NULL;
	IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'InitialNormalizedEntropy') IS NULL
		ALTER TABLE POLOXI.Legal_WideExecution ADD InitialNormalizedEntropy DECIMAL(5,4) NULL;
	IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'FinalNormalizedEntropy') IS NULL
		ALTER TABLE POLOXI.Legal_WideExecution ADD FinalNormalizedEntropy DECIMAL(5,4) NULL;
	IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'TotalActualInformationGain') IS NULL
		ALTER TABLE POLOXI.Legal_WideExecution ADD TotalActualInformationGain DECIMAL(9,4) NULL;
	IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'InformationRoundCount') IS NULL
		ALTER TABLE POLOXI.Legal_WideExecution ADD InformationRoundCount INT NOT NULL CONSTRAINT DF_Legal_PoloxiWideExecution_InfoRounds DEFAULT 0;
	IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'InformationTargetCount') IS NULL
		ALTER TABLE POLOXI.Legal_WideExecution ADD InformationTargetCount INT NOT NULL CONSTRAINT DF_Legal_PoloxiWideExecution_InfoTargets DEFAULT 0;
	IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'InformationRetrievalCount') IS NULL
		ALTER TABLE POLOXI.Legal_WideExecution ADD InformationRetrievalCount INT NOT NULL CONSTRAINT DF_Legal_PoloxiWideExecution_InfoRetrievals DEFAULT 0;
END;
