...
-- 2) POLOXI.Legal_WideExecution.ChallengeOutcomeJson persists the audit-only challenge verdict; the
...
BEGIN
	IF COL_LENGTH(N'POLOXI.Legal_WideExecution',N'ChallengeOutcomeJson') IS NULL
		ALTER TABLE POLOXI.Legal_WideExecution ADD ChallengeOutcomeJson NVARCHAR(MAX) NULL;
END
