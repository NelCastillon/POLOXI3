...
FROM POLOXI.Legal_ModelCapabilityProfile
...
FROM POLOXI.Legal_PromptStrategy
...
""",new{TenantId=tenantId,PurposeCode=purposeCode},cancellationToken:cancellationToken));
    ...
    {
        const string sql="""
INSERT POLOXI.Legal_AmbiguityRun(AmbiguityRunId,TenantId,QueryText,ComplexityLevelCode,AmbiguityLikelihood,SemanticComplexity,ConstraintComplexity,InteractionComplexity,EvidenceComplexity,ConceptCount,SelectedModelCode,SelectedScaffoldingCode,StatusCode,CreatedByUserId)
...
""";
    ...
    {
        const string sql="""
INSERT POLOXI.Legal_AmbiguityModelInvocation(TenantId,AmbiguityRunId,TaskTypeCode,ModelCode,PromptPurposeCode,PromptScaffoldingCode,PromptVersionNumber,InputTokenCount,OutputTokenCount,DurationMilliseconds,IsSuccess,IsSchemaValid,RetryNumber,EscalatedFromModelCode,FailureMessage)
...
""";
    ...
    public async Task RecordValidationIssuesAsync(Guid tenantId,Guid ambiguityRunId,int attemptNumber,IReadOnlyCollection<HierarchyValidationIssue> issues,CancellationToken cancellationToken=default)
    {
        ...
        const string sql="""
INSERT POLOXI.Legal_AmbiguityValidationIssue(TenantId,AmbiguityRunId,AttemptNumber,IssueCode,SeverityCode,NodeKey,IssueMessage)
...
INSERT POLOXI.Legal_AmbiguityNodeDependency(TenantId,AmbiguityRunId,SourceNodeKey,TargetNodeKey,DependencyTypeCode,Reason,Strength,CreatedByUserId)
