...
""";
        ...
        return (await connection.QueryAsync<AiProviderRoute>(new CommandDefinition(sql,new{TenantId=tenantId,FeatureCode=featureCode,CapabilityCode=capabilityCode,ModelCodeOverride=modelCodeOverride},cancellationToken:cancellationToken))).AsList();
    }
