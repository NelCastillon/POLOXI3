...
public sealed class PolicyEndorsementService : IPolicyEndorsementService
{
    ...
    public PolicyEndorsementService(IPolicyEndorsementRepository repository) => _repository = repository;
    ...
    public Task<Guid> CreateAsync(CreatePolicyEndorsementRequest request, CancellationToken cancellationToken = default)
