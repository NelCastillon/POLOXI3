...
public sealed record SaveAiProviderRequest(Guid TenantId,[Required,StringLength(100)]string ProviderCode,[Required,StringLength(200)]string DisplayName,[Required,StringLength(50)]string ProviderTypeCode,bool SupportsChat,bool SupportsEmbeddings,bool SupportsVision,bool SupportsStructuredOutput,[Range(0,1000)]int Priority,bool IsActive,Guid ActorUserId,byte[]? RowVersion);
public sealed record SaveAiModelDeploymentRequest(Guid TenantId,Guid ProviderId,[Required,StringLength(100)]string ModelCode,[Required,StringLength(200)]string DeploymentName,[Required,StringLength(100)]string ModelFamily,[Required,StringLength(50)]string CapabilityCode,[Range(1,100000000)]int ContextWindowTokens,[Range(1,100000000)]int MaximumOutputTokens,[Range(0,double.MaxValue)]decimal? InputCostPerMillionTokens,[Range(0,double.MaxValue)]decimal? OutputCostPerMillionTokens,[Required,StringLength(3,MinimumLength=3)]string CurrencyCode,[Range(0,1000)]int Priority,bool IsFallback,bool IsActive,Guid ActorUserId,byte[]? RowVersion);
