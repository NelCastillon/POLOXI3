...
public interface IPolicyLifecycleRepository
{
    ...
    Task<PolicyServicingWorkspaceDto?> GetWorkspaceAsync(Guid tenantId, Guid policyId, CancellationToken cancellationToken = default);
    ...
    Task<PolicyServicingActionResultDto> CreateActivityAsync(CreatePolicyServicingActivityRequest request, CancellationToken cancellationToken = default);
    Task<PolicyServicingActionResultDto> SendCommunicationAsync(SendPolicyCommunicationRequest request, CancellationToken cancellationToken = default);
}
