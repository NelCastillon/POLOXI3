...
{
    Task<AiConfigItemDto?> GetByIdAsync(Guid tenantId, Guid id, CancellationToken ct = default);
    ...
    Task UpdateAsync(Guid tenantId, Guid id, UpdateAiConfigItemRequest request, CancellationToken ct = default);
