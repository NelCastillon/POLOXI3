...
public interface ICommissionService
{
    ...
    Task<CommissionLedgerRowDto?> GetLedgerByIdAsync(Guid tenantId, Guid commissionId, CancellationToken cancellationToken = default);
    ...
    Task<Guid> CreateLedgerAsync(CreateCommissionLedgerRequest request, CancellationToken cancellationToken = default);
