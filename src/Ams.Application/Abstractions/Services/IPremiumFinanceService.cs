...
public interface IPremiumFinanceService
{
    ...
    Task<Guid> SubmitApplicationAsync(SubmitPremiumFinanceApplicationRequest request, CancellationToken cancellationToken = default);
