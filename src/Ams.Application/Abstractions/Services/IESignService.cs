...
public interface IESignService
{
    ...
    Task<ESignRequestDto?> GetByIdAsync(Guid eSignRequestId, CancellationToken cancellationToken = default);
    ...
    Task RemindAsync(Guid eSignRequestId, CancellationToken cancellationToken = default);
}
