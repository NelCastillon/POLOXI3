...
{
    Task<ServiceRequestDto?> GetByIdAsync(Guid tenantId, Guid id, CancellationToken cancellationToken = default);
    ...
    Task DeleteAsync(Guid tenantId, Guid id, Guid? modifiedByUserId, CancellationToken cancellationToken = default);
}
