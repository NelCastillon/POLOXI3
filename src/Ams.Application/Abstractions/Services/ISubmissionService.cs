...
public interface ISubmissionService
{
    ...
    Task<Guid?> RecordBindCarrierResponseAsync(Guid policyBindTransactionId, RecordBindCarrierResponseRequest request, CancellationToken cancellationToken = default);
