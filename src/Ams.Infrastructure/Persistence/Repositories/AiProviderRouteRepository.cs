...
(
    ...
    JOIN AI.ModelDeployment model ON model.ModelCode=@ModelCodeOverride AND model.CapabilityCode=@CapabilityCode AND model.IsActive=1 AND model.IsDeleted=0 AND (model.TenantId=policy.TenantId OR model.TenantId IS NULL)
