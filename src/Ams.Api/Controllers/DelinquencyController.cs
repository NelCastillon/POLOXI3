...
[ApiController]
[Route("api/billing/delinquency")]
public sealed class DelinquencyController : ControllerBase
{
    private readonly IDelinquencyFlagService _service;
    public DelinquencyController(IDelinquencyFlagService service) => _service = service;
