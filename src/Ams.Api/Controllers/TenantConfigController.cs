...
{
    private readonly ITenantConfigService _service;
    public TenantConfigController(ITenantConfigService service) => _service = service;
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] CreateTenantConfigItemRequest request, CancellationToken ct)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<IActionResult> Update(Guid id, [FromBody] UpdateTenantConfigItemRequest request, CancellationToken ct)
    {
