...
[ApiController]
[Route("api/billing/milestone-billing")]
public sealed class MilestoneBillingController : ControllerBase
{
    private readonly IMilestoneBillingLinkService _service;
    public MilestoneBillingController(IMilestoneBillingLinkService service) => _service = service;
