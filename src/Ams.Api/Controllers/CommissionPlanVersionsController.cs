...
[ApiController]
[Route("api/commissions/plan-versions")]
public sealed class CommissionPlanVersionsController : ControllerBase
{
    private readonly ICommissionPlanVersionService _service;

    public CommissionPlanVersionsController(ICommissionPlanVersionService service)
    {
        _service = service;
    }
