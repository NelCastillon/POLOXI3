...
[ApiController]
[Route("api/billing/retainers")]
public sealed class RetainerAccountsController : ControllerBase
{
    private readonly IRetainerAccountService _service;
    public RetainerAccountsController(IRetainerAccountService service) => _service = service;
