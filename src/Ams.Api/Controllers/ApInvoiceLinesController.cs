...
[ApiController]
[Route("api/finance/ap-invoice-lines")]
public sealed class ApInvoiceLinesController : ControllerBase
{
    private readonly IApInvoiceLineService _service;
    public ApInvoiceLinesController(IApInvoiceLineService service) => _service = service;
