...
[ApiController]
[Route("api/billing/prebill")]
public sealed class PrebillBatchesController : ControllerBase
{
    private readonly IPrebillBatchService _service;
    public PrebillBatchesController(IPrebillBatchService service) => _service = service;
