...
[ApiController]
[Route("api/billing/retainer-drawdowns")]
public sealed class RetainerDrawdownsController : ControllerBase
{
    private readonly IRetainerDrawdownService _service;
    public RetainerDrawdownsController(IRetainerDrawdownService service) => _service = service;
