...
public sealed class DataConfigController : ControllerBase
{
    private readonly IDataConfigService _service;
    public DataConfigController(IDataConfigService service) => _service = service;
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] CreateDataConfigItemRequest request, CancellationToken ct)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<IActionResult> Update(Guid id, [FromBody] UpdateDataConfigItemRequest request, CancellationToken ct)
    {
