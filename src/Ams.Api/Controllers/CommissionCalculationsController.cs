...
[ApiController]
[Route("api/commissions/calculations")]
public sealed class CommissionCalculationsController : ControllerBase
{
    private readonly ICommissionCalculationResultService _service;

    public CommissionCalculationsController(ICommissionCalculationResultService service)
    {
        _service = service;
    }
