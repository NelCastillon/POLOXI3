...
[ApiController]
[Route("api/crm/lead-activities")]
public sealed class LeadActivitiesController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] CreateLeadActivityRequest request, CancellationToken cancellationToken)
    {
