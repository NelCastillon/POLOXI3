...
[ApiController]
[Route("api/billing/rate-card-lines")]
public sealed class RateCardLinesController : ControllerBase
{
    private readonly IRateCardLineService _service;
    public RateCardLinesController(IRateCardLineService service) => _service = service;
