...
public sealed class WorkflowConfigController : ControllerBase
{
    ...
    public WorkflowConfigController(IWorkflowConfigService service) => _service = service;
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] CreateWorkflowConfigItemRequest request, CancellationToken ct)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<IActionResult> Update(Guid id, [FromBody] UpdateWorkflowConfigItemRequest request, CancellationToken ct)
    {
