...
[ApiController]
[Route("api/billing/rate-cards")]
public sealed class RateCardsController : ControllerBase
{
    private readonly IRateCardService _service;
    public RateCardsController(IRateCardService service) => _service = service;
