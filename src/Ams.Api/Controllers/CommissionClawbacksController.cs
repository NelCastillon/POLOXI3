...
[ApiController]
[Route("api/commissions/clawbacks")]
public sealed class CommissionClawbacksController : ControllerBase
{
    private readonly ICommissionClawbackService _service;

    public CommissionClawbacksController(ICommissionClawbackService service)
    {
        _service = service;
    }
